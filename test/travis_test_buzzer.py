...
class BuzzerTest(unittest.TestCase):
	...
	def test_music(self):
		...
		self.assertEqual(goal.freqs, self.device_values, "invalid feedback:" + ",".join([str(e) for e in self.device_value]))
		...
		self.assertFalse(self.client.get_result(),"stop is requested but result true")
